...
function qtipText(node) {
  return 'Reference:' + node.data('reference') + 'Race: '+ node.data('race') +  '&nbsp </br>' + 'Age group: ' + node.data('age_groups') + '&nbsp </br>' + 'Gender: ' + node.data('gender') + '&nbsp</br> ' + 'Country: ' + node.data('tissue_source_country');
}
